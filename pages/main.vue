        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="image-container">
              <img
                class="img-fluid"
                src="~assets/images/intro-office.jpg"
                alt="alternative"
              />
            </div>
            ...
            <div id="headingOne">
              ...
              >
                ...
                ><span class="accordion-title"
                  >How Can Aria Help Your Business</span
                >
              </span>
            </div>
            <div
          ...
          <div class="item">
            <div id="headingTwo">
              ...
              >
                ...
                ><span class="accordion-title"
                  >Great Strategic Business Planning</span
                >
              </span>
            </div>
            <div
          ...
          <ul class="nav nav-tabs" id="ariaTabs" role="tablist">
            <li class="nav-item">
              <a
                ...
                aria-controls="tab-1"
                aria-selected="true"
                ><i class="fas fa-th"></i> Business</a
              >
            </li>
            <li class="nav-item">
              <a
                ...
                aria-controls="tab-2"
                aria-selected="false"
                ><i class="fas fa-th"></i> Expertise</a
              >
            </li>
            <li class="nav-item">
              <a
          ...
          <div class="tab-content" id="ariaTabsContent">
            ...
            >
              ...
              <p>
                ...
                <a class="green page-scroll" href="#services">Services</a>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p class="p-heading">
              ...
              future for our company without helping them reach their objectives
            </p>
          </div>
          <!-- end of col -->
        </div>
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <div class="card">
                      <img
                        class="card-image"
                        src="~assets/images/testimonial-6.jpg"
                        alt="alternative"
                      />
                      <div class="card-body">
                        <div class="testimonial-text">
            ...
            <div class="grid">
              <div class="element-item development">
                <a class="popup-with-move-anim" href="#project-1"
                  ...
                  <img src="~assets/images/project-1.jpg" alt="alternative"
                /></a>
              </div>
              <div class="element-item development">
                <a class="popup-with-move-anim" href="#project-2"
                  ...
                  <img src="~assets/images/project-2.jpg" alt="alternative"
                /></a>
              </div>
              <div class="element-item design development marketing">
                <a class="popup-with-move-anim" href="#project-3"
                  ...
                  <img src="~assets/images/project-3.jpg" alt="alternative"
                /></a>
              </div>
              <div class="element-item design development marketing">
                <a class="popup-with-move-anim" href="#project-4"
                  ...
                  <img src="~assets/images/project-4.jpg" alt="alternative"
                /></a>
              </div>
              <div class="element-item design development marketing seo">
                <a class="popup-with-move-anim" href="#project-5"
                  ...
                  <img src="~assets/images/project-5.jpg" alt="alternative"
                /></a>
              </div>
              <div class="element-item design marketing seo">
                <a class="popup-with-move-anim" href="#project-6"
                  ...
                  <img src="~assets/images/project-6.jpg" alt="alternative"
                /></a>
              </div>
              <div class="element-item design marketing">
                <a class="popup-with-move-anim" href="#project-7"
                  ...
                  <img src="~assets/images/project-7.jpg" alt="alternative"
                /></a>
              </div>
              <div class="element-item design marketing">
                <a class="popup-with-move-anim" href="#project-8"
                  ...
                  <img src="~assets/images/project-8.jpg" alt="alternative"
                /></a>
              </div>
            </div>
            <!-- end of grid -->
